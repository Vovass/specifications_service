...
class VariationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variation" do
    assert_difference('Variation.count') do
      post variations_url, params: { variation: { description: @variation.description, name: @variation.name } }
    end
  ...
  test "should update variation" do
    patch variation_url(@variation), params: { variation: { description: @variation.description, name: @variation.name } }
