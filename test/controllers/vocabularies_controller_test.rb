...
class VocabulariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vocabulary" do
    assert_difference('Vocabulary.count') do
      post vocabularies_url, params: { vocabulary: { description: @vocabulary.description, name: @vocabulary.name, spec_name: @vocabulary.spec_name } }
    end
  ...
  test "should update vocabulary" do
    patch vocabulary_url(@vocabulary), params: { vocabulary: { description: @vocabulary.description, name: @vocabulary.name, spec_name: @vocabulary.spec_name } }
